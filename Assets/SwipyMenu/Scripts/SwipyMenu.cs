...
namespace Cubequad
{
    ...
    public class SwipyMenu : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public RectTransform AddMenu(out RectTransform headerRoot, out RectTransform menuRoot)
        {
            ...
            var text = CreateGOWithRectTransform("Text", currentHeader, sizeDelta: new Vector2(-5f,-5f)).gameObject.AddComponent<Text>();
